            ...
            (let iter ((points (sort-by-proximity point (delete point random-points))))
              (unless (null? points)
                (let ((counter-point (car points)))
                  (unless (memq counter-point (hash-table-ref connections point '()))
                    (let iter ((counter-counter-points (hash-table-keys connections)))
                      (let iter ((counter-counter-counter-points (hash-table-ref/default connections counter-counter-point '()))))))))))
        random-points))
