               ...
               (begin
                 ...
                 (if (stack-empty? (hash-table-ref/default untried points (make-stack)))
                     (if (stack-empty? (hash-table-ref/default unbacktracked points (make-stack)))
                         ...
                         (let ((backtrack (hash-table-ref unbacktracked points)))
                           (debug 'harro)
                           (set! previous-action (car points))))
                     (begin
                       (debug 'warro)
                       (set! previous-action (car (stack-pop! (hash-table-ref untried points))))))
