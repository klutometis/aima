...
* TODO 3.2
** TODO a
   - States :: A graph whose nodes point east, west, north, south; and
               the square currently occupied by the robot.
   - Initial state :: Graph of one node: the current location
   - Actions :: East, west, north, south, forward
   - Transition model :: Moves in the activating direction wherever a
        wall does not intervene; in the latter case, stays put.
   - Goal test :: The robot is out of the maze.
   - Path cost :: None

   NB: There's fire possibilities for each square.
** TODO b
* TODO 3.7
