...
* TODO 1.4
  ...
  At the very least, a program that can score better on IQ tests; the
  mapping from IQ-test-scores has been debated (though the correlation
  to income is well established), leading to the multiplication of
  "intelligences": emotional, spatial, synthetic, etc.
