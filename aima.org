     ...
     (lambda (vacuum-world action)
       (if (suck? action)
           (if (left? (vacuum-world-robot vacuum-world))
               (if (dirty? (vacuum-world-left vacuum-world))
                   (if (dirty? (vacuum-world-right vacuum-world))
                       (list (make-vacuum-world clean dirty left)
                             (make-vacuum-world clean clean left))
                       (list (make-vacuum-world clean clean left)))
                   (list (make-vacuum-world clean (vacuum-world-right vacuum-world) left)
                         (make-vacuum-world dirty (vacuum-world-right vacuum-world) left)))
               (if (dirty? (vacuum-world-right vacuum-world))
                   (if (dirty? (vacuum-world-left vacuum-world))
                       (list (make-vacuum-world dirty clean right)
                             (make-vacuum-world clean clean right))
                       (list (make-vacuum-world clean clean right)))
                   (list (make-vacuum-world (vacuum-world-left vacuum-world) clean right)
                         (make-vacuum-world (vacuum-world-left vacuum-world) dirty right))))
           (if (left? action)
