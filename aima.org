...
*** TODO Embedded R
    ...
    #+BEGIN_SRC c :tangle Reval.c
      ...
      SEXP toR(C_word arg) {
        ...
        /* What the fuck is this, if not above? */
        return R_NilValue;
      }
      ...
      void Reval(C_word c, C_word self, C_word k, C_word name, C_word args) {
        ...
        while (!C_truep(C_i_nullp(args))) {
          ...
          if (C_truep(C_i_flonump(arg))) {
            ...
            puts("pointer!");
            /* Rarg = C_scheme_or_c_pointer(arg); */
            /* Rarg = C_data_pointer(arg); */
            /* Rarg = C_pointer_to_object(arg); */
            Rarg = C_a_i_data_mpointer(arg, 1, 1);
          }
          SETCAR(iterexp, Rarg);
          args = C_i_cdr(args);
          iterexp = CDR(iterexp);
        ...
        if (!error) {
          ...
          default:
            {
              /* const char *TAG = "R"; */
              /* C_word *tag = C_alloc(C_SIZEOF_STRING(strlen(TAG))); */
              /* C_string(&tag, strlen(TAG), (char *) TAG); */
