...
* TODO 3.4
  ...
  Without loss of generality, we'll illustrate on a 4-puzzle; whose
  game-graph is the following:

  #+CAPTION: 4-puzzle game-graph
  #+ATTR_LATEX: placement=[H]
  #+BEGIN_SRC dot :file img/3-4.pdf :cmd neato
    digraph G {
      1
      2
      3
  ...
  #+CAPTION: Canonical 4-puzzle permutation (even)
  #+ATTR_LATEX: placement=[H]
  ...
  cycles (e.g. $(1\ 2)$) away from the canonical version:

  #+CAPTION: Odd 4-puzzle permutation
  #+ATTR_LATEX: placement=[H]
  ...
  #+CAPTION: Even 4-puzzle permutation
  #+ATTR_LATEX: placement=[H]
