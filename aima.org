...
** TODO Simulation
  ...
  (define (simulate-navigation n-points n-steps animation-file make-agent)
   ...
   #+END_SRC
** TODO c
   #+BEGIN_SRC scheme :comments links :tangle online-dfs-non-deterministic.scm :shebang #!/usr/bin/env chicken-scheme
     (use aima-tessellation
          animation
          define-record-and-printer
          debug
