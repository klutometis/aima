...
* TODO 6.10
  #+BEGIN_SRC scheme
    ...
    (let ((points (random-points 100))
          (connections (make-hash-table)))
      (let iter ((points points))
        (for-each
           (lambda (point)
             (let iter ((counter-points
                         (sort-by-proximity point (delete point points))))
               (unless (null? counter-points)
                 (let ((counter-point (car counter-points)))
                   (if (memq counter-point
                             (hash-table-ref/default connections point '()))
                       (iter (cdr counter-points))
                       (hash-table-update!/default
                        connections
                        point
                        ...
                        '()))
                   ;; (unless (memq counter-point (hash-table-ref/default connections point '()))
                   ;;   (let iter ((counter-counter-points (hash-table-keys connections)))
                   ;;     (unless (null? counter-counter-points)
                   ;;       (let ((counter-counter-point (car counter-counter-points)))
                   ;;         (let iter ((counter-counter-counter-points
                   ;;                     (hash-table-ref/default connections counter-counter-point '())))
                   ;;           (if (null? counter-counter-counter-points)
                   ;;               (hash-table-update!/default
                   ;;                connections
                   ;;                point
                   ;;                (lambda (counter-points)
                   ;;                  (lset-adjoin eq? counter-points counter-point))
                   ;;                '())
                   ;;               (let ((counter-counter-counter-point
                   ;;                      (car counter-counter-counter-points)))
                   ;;                 (unless (intersect? point
                   ;;                                     counter-point
                   ;;                                     counter-counter-point
                   ;;                                     counter-counter-counter-point)
                   ;;                   (iter (cdr counter-counter-counter-points))))))))))
                   ))))
         points)
